package com.aicode.core.infrastructure.prompt;
...
import com.aicode.core.infrastructure.config.PromptProperties;
...
public class ClasspathPromptTemplateAdapter implements PromptTemplatePort {
    ...
    public ClasspathPromptTemplateAdapter(PromptProperties properties) {
    ...
    public PromptTemplate render(String name, Map<String, Object> variables) {
        validateName(name);
        String version = properties.resolvedVersion();
