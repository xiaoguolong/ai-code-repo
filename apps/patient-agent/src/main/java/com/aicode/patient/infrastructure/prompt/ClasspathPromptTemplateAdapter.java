package com.aicode.patient.infrastructure.prompt;
...
import com.aicode.patient.infrastructure.config.AgentProperties;
...
public class ClasspathPromptTemplateAdapter implements PromptTemplatePort {
    ...
    public ClasspathPromptTemplateAdapter(AgentProperties properties) {
    ...
    public PromptTemplate render(String name, Map<String, Object> variables) {
        validateName(name);
        String version = properties.promptVersion();
